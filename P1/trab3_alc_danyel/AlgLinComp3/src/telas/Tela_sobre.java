...
public class Tela_sobre extends JFrame {
	...
	public Tela_sobre() {
		...
		ajudalabel.setText("<html> Programa desenvolvido pelo aluno Danyel Clin\u00E1rio dos Santos, <br>utilizando o pacote de desenvolvimento Java 11. O Programa <br> foi desenvolvido para a terceira avalia\u00E7\u00E3o da disciplina \u00C1lgebra <br> Linear Computacional, ministrada pelo Professor Lu\u00EDs Volnei  <br> Sudati Sagrilo, no ano de 2021, no per\u00EDodo 2020.2 da Faculdade <br>Federal do Rio de Janeiro - UFRJ</html>");
